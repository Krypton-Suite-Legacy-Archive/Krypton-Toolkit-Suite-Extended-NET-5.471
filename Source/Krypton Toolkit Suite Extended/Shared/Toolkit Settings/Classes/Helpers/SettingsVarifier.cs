...
using ToolkitSettings.Classes.ApplicationUpdater;
using ToolkitSettings.Classes.ExtendedControls;
...
namespace ToolkitSettings.Classes.Helpers
{
    public class SettingsVarifier
    {
        ...
        {
            ApplicationUpdater.ThemeSettingsManager manager = new ApplicationUpdater.ThemeSettingsManager();
        ...
        {
            ExtendedControls.ThemeSettingsManager manager = new ExtendedControls.ThemeSettingsManager();
        ...
        {
            ExtendedControls.WindowLocationSettingsManager manager = new ExtendedControls.WindowLocationSettingsManager();
