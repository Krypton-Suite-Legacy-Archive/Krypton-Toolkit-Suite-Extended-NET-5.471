...
namespace Common.Controls.ToolbarItems
{
    ...
    public partial class KryptonToolbarSlider : UserControl, IContentValues
    {
        ...
        private void k_palette_PalettePaint(object sender, ComponentFactory.Krypton.Toolkit.PaletteLayoutEventArgs e)
        {
            this.Invalidate();
        }
        ...
        public System.Drawing.Image GetImage(ComponentFactory.Krypton.Toolkit.PaletteState state)
        {
            return null;
        }
        public System.Drawing.Color GetImageTransparentColor(ComponentFactory.Krypton.Toolkit.PaletteState state)
        {
            return Color.Empty;
        }
        ...
        public class SliderEventArgs : System.EventArgs
        {
            ...
            {
                string RetStr = "";
                RetStr += "Values: " + DateAndTime.Now.ToLongTimeString() + Constants.vbCrLf;
                RetStr += "NewValue: " + m_newvalue + Constants.vbCrLf;
                RetStr += "OldValue: " + m_oldvalue + Constants.vbCrLf;
                RetStr += "Range: " + m_range + Constants.vbCrLf;
                RetStr += "Steps: " + m_steps + Constants.vbCrLf;
                return RetStr;
            }
