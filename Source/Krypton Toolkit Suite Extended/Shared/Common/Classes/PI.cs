...
namespace Common.Classes
{
    ...
    **/
    ...
    #region Toolkit Features
    public class ToolkitPI
    {
        #region statics
        /// <summary>
        ...
        public struct TV_ITEM
        {
            ...
            internal TVIS_ State { get => state; set => state = value; }
            internal TVIS_ StateMask { get => stateMask; set => stateMask = value; }
            internal TVIF_ Mask { get => mask; set => mask = value; }
        }
        ...
        public struct CURSORINFO
        {
            ...
            private POINT ptScreenPos;   // A POINT structure that receives the screen coordinates of the cursor. 

            internal POINT PtScreenPos { get => ptScreenPos; set => ptScreenPos = value; }
        }
