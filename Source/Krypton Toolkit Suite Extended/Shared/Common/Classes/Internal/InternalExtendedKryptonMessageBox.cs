...
namespace Common
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    [ToolboxBitmap(typeof(InternalExtendedKryptonMessageBox), "ToolboxBitmaps.KryptonMessageBox.bmp")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    internal class InternalExtendedKryptonMessageBox : KryptonForm
    {
        #region System
        private void InitialiseComponent()
        {
            ...
            MaximizeBox = false;
            MinimizeBox = false;
            Name = "InternalExtendedKryptonMessageBox";
            ShowIcon = false;
            ShowInTaskbar = false;
        ...
        /// <summary>
        /// Gets or sets the time out for the <see cref="InternalExtendedKryptonMessageBox"/>.
        /// </summary>
        /// <value>
        /// The time out.
        /// </value>
        ...
        #region Constructors
        static InternalExtendedKryptonMessageBox()
        {
            _osMajorVersion = Environment.OSVersion.Version.Major;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="InternalExtendedKryptonMessageBox"/> class.
        /// </summary>
        ...
        private InternalExtendedKryptonMessageBox(IWin32Window showOwner, string text, string caption,
