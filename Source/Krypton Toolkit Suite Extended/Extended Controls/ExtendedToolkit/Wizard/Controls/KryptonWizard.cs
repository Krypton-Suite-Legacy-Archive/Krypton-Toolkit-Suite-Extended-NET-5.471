...
using ExtendedControls.ExtendedToolkit.Wizard.Classes;
using System;
...
namespace ExtendedControls.ExtendedToolkit.Wizard.Controls
{
    /// <summary>
    ...
    public class KryptonWizard : UserControl
    {
        ...
        protected internal ComponentFactory.Krypton.Toolkit.KryptonButton btnBack;
        protected internal ComponentFactory.Krypton.Toolkit.KryptonButton btnNext;
        protected internal ComponentFactory.Krypton.Toolkit.KryptonButton btnCancel;
        protected internal ComponentFactory.Krypton.Toolkit.KryptonPanel kryptonPanel1;
