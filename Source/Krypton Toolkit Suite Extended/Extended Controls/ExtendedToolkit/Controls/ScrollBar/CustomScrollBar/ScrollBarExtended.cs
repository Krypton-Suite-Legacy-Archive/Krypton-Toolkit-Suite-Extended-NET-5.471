...
namespace ExtendedControls.ExtendedToolkit.Controls.ScrollBar.CustomScrollBar
{
    /// <summary>
    ...
    public class ScrollBarExtended : Control
    {
        #region fields
        ...
        /// The border color.
        /// </summary>
        private Color borderColour = Color.FromArgb(93, 140, 201);

        /// <summary>
        /// The border color in disabled state.
        /// </summary>
        private Color disabledBorderColour = Color.Gray;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScrollBarExtended"/> class.
        /// </summary>
        public ScrollBarExtended()
        {
        ...
        public Color DisabledBorderColour
        {
            get
            {
                return disabledBorderColour;
            }

            set
            {
                disabledBorderColour = value;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            ScrollBarExtendedRenderer.InitColors();

            // draws the background
            ScrollBarExtendedRenderer.DrawBackground(
               e.Graphics,
               ClientRectangle,
               orientation);

            // draws the track
            ScrollBarExtendedRenderer.DrawTrack(
               e.Graphics,
               rect,
            ...
            // draw thumb and grip
            ScrollBarExtendedRenderer.DrawThumb(
               e.Graphics,
               thumbRectangle,
               thumbState,
               orientation);
            ...
            if (Enabled)
            {
                ScrollBarExtendedRenderer.DrawThumbGrip(
                   e.Graphics,
                   thumbRectangle,
                   orientation);
            }
            ...
            // draw arrows
            ScrollBarExtendedRenderer.DrawArrowButton(
               e.Graphics,
               topArrowRectangle,
               topButtonState,
               true,
            ...
            using (Pen pen = new Pen(
               (Enabled ? ScrollBarExtendedRenderer.borderColours[0] : disabledBorderColour)))
            {
