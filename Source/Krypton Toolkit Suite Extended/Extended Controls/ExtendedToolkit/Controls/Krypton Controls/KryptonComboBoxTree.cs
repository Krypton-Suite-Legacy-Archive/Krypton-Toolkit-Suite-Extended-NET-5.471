...
namespace ExtendedControls.ExtendedToolkit.Controls.KryptonControls
{
    ...
    public sealed class KryptonComboBoxTree : Control
    {
        ...
        [Browsable(false)]
        public ComponentFactory.Krypton.Toolkit.KryptonComboBox ComboBox
        {
            get { return combobox; }
            set { combobox = value; }
        }
        ...
        #endregion
        #region ButtonEx
        private class ButtonEx : ComponentFactory.Krypton.Toolkit.KryptonButton
        {
