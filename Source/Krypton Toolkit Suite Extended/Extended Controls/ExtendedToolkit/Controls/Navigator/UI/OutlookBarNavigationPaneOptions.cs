...
using ExtendedControls.ExtendedToolkit.Controls.Navigator.Classes;
using Microsoft.VisualBasic;
using System;

namespace ExtendedControls.ExtendedToolkit.Controls.Navigator.UI
{
    public partial class OutlookBarNavigationPaneOptions : KryptonForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.kbtnMoveUp = new ComponentFactory.Krypton.Toolkit.KryptonButton();
            this.kbtnMoveDown = new ComponentFactory.Krypton.Toolkit.KryptonButton();
            this.kbtnReset = new ComponentFactory.Krypton.Toolkit.KryptonButton();
            this.kbtnCancel = new ComponentFactory.Krypton.Toolkit.KryptonButton();
            this.kbtnOk = new ComponentFactory.Krypton.Toolkit.KryptonButton();
            this.kclbItems = new ComponentFactory.Krypton.Toolkit.KryptonCheckedListBox();
