...
{
    //[ToolboxBitmap(typeof(LoadingCircle), "AC.ExtendedRenderer.Toolkit.StdControls.Images.LoadingCircle.bmp"), ToolboxItem(true), ToolStripItemDesignerAvailability(ToolStripItemDesignerAvailability.All)]
