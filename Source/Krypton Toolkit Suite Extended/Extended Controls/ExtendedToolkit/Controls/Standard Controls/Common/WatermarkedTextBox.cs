...
{
    [ToolboxBitmap(typeof(TextBox)), ToolboxItem(false)]
    public partial class WatermarkedTextBox : TextBox
    {
        ...
        private Color originalFontColorField;
        ...
        public WatermarkedTextBox()
        {
            ...
            this.originalFontColorField = base.ForeColor;
        ...
        private void syncupText(bool focused)
        {
            if (focused)
            {
                ...
                if (this.waterMarkedField)
                {
                    ...
                    base.ForeColor = this.originalFontColorField;
                }
            }
            else
            {
        ...
        private void setWaterMarkFont()
        {
            ...
            if (!this.watermarkUsePaletteFontColorField)
            {
                ...
                base.ForeColor = this.waterMarkFontColorField;
            }
            else
            {
