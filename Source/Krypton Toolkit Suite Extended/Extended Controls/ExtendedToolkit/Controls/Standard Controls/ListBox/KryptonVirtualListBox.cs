...
namespace ExtendedControls.ExtendedToolkit.Controls.StandardControls.ListBox
{
    ...
    /// </summary>
    public class KryptonVirtualListBox : KryptonListBox
    {
        /*
		* Listbox Styles
		*/
        ...
        private KryptonVirtualListBox.SelectedIndexCollection selectedIndices = null;
        #endregion
        ...
        /// </summary>
        public KryptonVirtualListBox() : base()
        {
            selectedIndices = new KryptonVirtualListBox.SelectedIndexCollection(this);
            this.ListBox.DrawItem += new DrawItemEventHandler(DrawItem);
        }
		...
		*/
        ...
        /// VListBox.
        /// </summary>
        public class SelectedIndexCollection : ICollection, IEnumerable
        {
            private KryptonVirtualListBox owner = null;
