...
namespace KryptonExtendedToolkit.ExtendedToolkit.UI
{
    ...
    [ComVisible(true)]
    public class KryptonFormWithDropShadow : VisualForm, IContentValues
    {
        ...
        public class FormButtonSpecCollection : ButtonSpecCollection<ButtonSpecAny>
        {
            ...
            public FormButtonSpecCollection(KryptonFormWithDropShadow owner)
                : base(owner)
            {
            }
            #endregion
        ...
        /// </summary>
        public class FormFixedButtonSpecCollection : ButtonSpecCollection<Base.ButtonSpecFormFixed>
        {
            #region Identity
            /// <summary>
            ...
            /// </summary>
            /// <param name="owner">Reference to owning object.</param>
            public FormFixedButtonSpecCollection(KryptonFormWithDropShadow owner)
                : base(owner)
            {
            }
            #endregion
        ...
        #region Identity
        /// <summary>
        /// Initialise a new instance of the <see cref="KryptonFormWithDropShadow"/> class.
        /// </summary>
        public KryptonFormWithDropShadow()
        {
            // Default properties
            ...
            ButtonSpecMin = new Base.ButtonSpec.ButtonSpecFormWindowMin(this);
            ButtonSpecMax = new Base.ButtonSpec.ButtonSpecFormWindowMax(this);
            ButtonSpecClose = new Base.ButtonSpec.ButtonSpecFormWindowClose(this);
            _buttonSpecsFixed.AddRange(new Base.ButtonSpecFormFixed[] { ButtonSpecMin, ButtonSpecMax, ButtonSpecClose });
        ...
        public Base.ButtonSpec.ButtonSpecFormWindowMin ButtonSpecMin { get; }
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public Base.ButtonSpec.ButtonSpecFormWindowMax ButtonSpecMax { get; }
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public Base.ButtonSpec.ButtonSpecFormWindowClose ButtonSpecClose { get; }
        ...
        public override void WindowChromeCompositionPaint(ComponentFactory.Krypton.Toolkit.RenderContext context)
        {
                ...
                if (ViewManager != null)
                {
                    ...
                    if (NeedLayout || (GetDefinedIcon() != _cacheIcon))
                    {
                        ...
                        else
                        {
                            ...
                            using (ComponentFactory.Krypton.Toolkit.RenderContext context = new ComponentFactory.Krypton.Toolkit.RenderContext(this, null, Bounds, Renderer))
                            {
        ...
        private void UpdateCustomChromeDecision()
        {
            if (IsHandleCreated)
            {
                ...
                if (ApplyCustomChrome != needChrome)
                {
                    _recreateButtons = true;
                    _firstCheckView = true;
                    //Base.UI.VisualForm.ApplyCustomChrome = needChrome;
