...
namespace ExtendedControls.ExtendedToolkit.Renderer.Classes
{
    ...
    public class Office2007Renderer : ToolStripProfessionalRenderer
    {
        ...
        public class GradientItemColours
        {
            ...
            #region Identity
            public GradientItemColours(Color insideTop1, Color insideTop2,
        ...
        private static GradientItemColours _itemContextItemEnabledColors = new GradientItemColours(_r1, _r2, _r3, _r4, _r5, _r6, _r7, _r8, Color.FromArgb(217, 203, 150), Color.FromArgb(192, 167, 118));
        private static GradientItemColours _itemDisabledColors = new GradientItemColours(_c4, _c6, Color.FromArgb(236, 236, 236), Color.FromArgb(230, 230, 230), _c6, Color.FromArgb(224, 224, 224), Color.FromArgb(200, 200, 200), Color.FromArgb(210, 210, 210), Color.FromArgb(212, 212, 212), Color.FromArgb(195, 195, 195));
        private static GradientItemColours _itemToolItemSelectedColors = new GradientItemColours(_r1, _r2, _r3, _r4, _r5, _r6, _r7, _r8, _r9, _rA);
        private static GradientItemColours _itemToolItemPressedColors = new GradientItemColours(_rD, _rE, _rF, _rG, _rH, _rI, _rJ, _rK, _r9, _rA);
        private static GradientItemColours _itemToolItemCheckedColors = new GradientItemColours(_rL, _rM, _rN, _rO, _rP, _rQ, _rR, _rS, _r9, _rA);
        private static GradientItemColours _itemToolItemCheckPressColors = new GradientItemColours(_rT, _rU, _rV, _rW, _rX, _rI, _rY, _rZ, _r9, _rA);
        #endregion
        ...
        public Office2007Renderer()
            : base(new Office2007ColourTable())
        {
        }

        private static ProfessionalColourTable ColourTables;
        public Office2007Renderer(ProfessionalColourTable colourTable)
            : base(colourTable)
        {
            ColourTables = colourTable;
        }
        #endregion
        ...
        protected override void OnRenderItemText(ToolStripItemTextRenderEventArgs e)
        {
                ...
                (e.ToolStrip is ToolStripDropDownMenu))
            {
                ...
                {
                    //for Default renderer version
                    if (ColourTables != null)
                    {
                        if ((e.ToolStrip is MenuStrip) && !e.Item.Pressed && !e.Item.Selected)
                            e.TextColor = ColourTables.MenuItemText;//_textMenuStripItem;
                        else if ((e.ToolStrip is StatusStrip) && !e.Item.Pressed && !e.Item.Selected)
                            e.TextColor = ColourTables.StatusStripText;//_textStatusStripItem;
                        else
                            e.TextColor = ColourTables.ContextMenuItemText;
                    }
                    else
                    {
                        if ((e.ToolStrip is MenuStrip) && !e.Item.Pressed && !e.Item.Selected)
        ...
        private void DrawGradientToolSplitItem(Graphics g,
                                               ToolStripSplitButton splitButton,
                                               GradientItemColours colorsButton,
                                               GradientItemColours colorsDrop,
                                               GradientItemColours colorsSplit)
        {
