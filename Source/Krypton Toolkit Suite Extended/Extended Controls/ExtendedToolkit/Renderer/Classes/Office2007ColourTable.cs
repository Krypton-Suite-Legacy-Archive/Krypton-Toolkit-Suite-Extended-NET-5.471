...
namespace ExtendedControls.ExtendedToolkit.Renderer.Classes
{
    ...
    /// </summary>
    public class Office2007ColourTable : ProfessionalColourTable
    {
        ...
        private static Color _textMenuStripItem = Color.FromArgb(21, 66, 139);
        private static Color _textStatusStripItem = Color.FromArgb(21, 66, 139);
        private static Color _textContextMenuItem = Color.FromArgb(21, 66, 139);
        private static Color _arrowDisabled = Color.FromArgb(167, 167, 167);
