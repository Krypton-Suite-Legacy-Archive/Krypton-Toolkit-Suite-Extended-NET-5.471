...
namespace ExtendedControls.Base.Code.Colours.ColourWheel
{
    public class Utilities
    {
        ...
        public static PointF Centre(RectangleF r)
        {
            PointF centre = r.Location;
            centre.X += r.Width / 2;
            centre.Y += r.Height / 2;
            return centre;
        }
        ...
        public static void Draw2ColourBar(Graphics dc, RectangleF r, Orientation orientation, Color c1, Color c2)
        {
            RectangleF lr1 = r;
            float angle = 0;
        ...
        public static void Draw3ColourBar(Graphics dc, RectangleF r, Orientation orientation, Color c1, Color c2, Color c3)
        {
