...
namespace ExtendedControls.Base.Code.Security
{
    public class HashingAlgorithms
    {
        ...
        #region Methods
        public static void GenerateMD5Hash(BackgroundWorker md5Worker, string filePath, Control output)
        {
        ...
        private static void MD5Worker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            using (Stream fileStream = File.OpenRead(filePath))
            {
                ...
                using (HashAlgorithm md5 = MD5.Create())
                {
                    ...
                    e.Result = ConstructMD5HashString(md5.Hash);
                }
            }
        }
        #endregion
        ...
        {
            HashingAlgorithms algorithms = new HashingAlgorithms();

            algorithms.MD5Output = value;
        }
