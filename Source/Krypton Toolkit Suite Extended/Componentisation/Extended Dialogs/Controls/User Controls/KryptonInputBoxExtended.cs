...
namespace ExtendedDialogs.Controls.UserControls
{
    public class KryptonInputBoxExtended : UserControl
    {
        ...
        private ComponentFactory.Krypton.Toolkit.KryptonButton kbtnAbort;
        private ComponentFactory.Krypton.Toolkit.KryptonButton kbtnYes;
        private Panel panel1;
        private ComponentFactory.Krypton.Toolkit.KryptonPanel kryptonPanel2;
        private ComponentFactory.Krypton.Toolkit.KryptonTextBox ktxtUserResponse;
        private ComponentFactory.Krypton.Toolkit.KryptonComboBox kcmbUserChoice;
        private ComponentFactory.Krypton.Toolkit.KryptonLabel klblMessage;
        private PictureBox pbxIcon;
        private ComponentFactory.Krypton.Toolkit.KryptonButton kbtnNo;
