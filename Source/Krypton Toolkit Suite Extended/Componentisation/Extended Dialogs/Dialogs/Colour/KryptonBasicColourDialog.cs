...
namespace ExtendedDialogs.Dialogs.Colour
{
    public class KryptonBasicColourDialog : KryptonForm
    {
        ...
        private ExtendedColourControls.ColourWheel cwColourSelector;
        private KryptonToolkitSuiteExtendedCore.CircularPictureBox cpbSelectedColour;
        private ExtendedColourControls.Controls.Labels.KryptonBlueValueLabel kbvlBlue;
        private ExtendedColourControls.Controls.Labels.KryptonGreenValueLabel kgvlGreen;
        private ExtendedColourControls.Controls.Labels.KryptonRedValueLabel krvlRed;
