...
namespace KryptonToolkitSuiteExtendedCore.Components.Controls.UI
{
    public class KryptonMessageBoxExtendedTest : KryptonForm
    {
        #region System
        private void InitializeComponent()
        {
            ...
            this._button3 = new KryptonToolkitSuiteExtendedCore.Components.Controls.UI.KryptonMessageBoxExtendedTest.MessageButton();
            this._button1 = new KryptonToolkitSuiteExtendedCore.Components.Controls.UI.KryptonMessageBoxExtendedTest.MessageButton();
            this._button2 = new KryptonToolkitSuiteExtendedCore.Components.Controls.UI.KryptonMessageBoxExtendedTest.MessageButton();
        ...
        private KryptonPanel kpnlMessage;
        ...
        #region Constructors
        static KryptonMessageBoxExtendedTest()
        {
            _osMajorVersion = Environment.OSVersion.Version.Major;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="KryptonMessageBoxExtendedTest"/> class.
        /// </summary>
        ...
        private KryptonMessageBoxExtendedTest(IWin32Window showOwner, string text, string caption,
