...
{
    public class MRUExample : KryptonForm
    {
        #region Designer Code
        private KryptonRichTextBox krtbEditor;
        ...
        private void InitializeComponent()
        {
            ...
            this.kryptonPanel1.Size = new System.Drawing.Size(1471, 864);
        ...
        #region Variables
        private MostRecentlyUsedFileManager mru = null;
        #endregion
        ...
        private void OpenFile(string filePath)
        {
            if (File.Exists(filePath))
            {
                ...
                krtbEditor.Text = reader.ReadToEnd();

                mru.AddRecentFile(filePath);
            }
            else
            {
        ...
        private void SaveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            })
            {
                if (saveFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    mru.AddRecentFile(Path.GetFullPath(saveFileDialog.FileName));
                }
            }
        }
    }
