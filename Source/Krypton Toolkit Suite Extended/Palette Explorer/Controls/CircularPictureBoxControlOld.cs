...
namespace PaletteExplorer.Controls
{
    ...
    public class CircularPictureBoxControlOld : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.cbxBaseColourPreview.MouseDoubleClick += new System.Windows.Forms.MouseEventHandler(this.CbxBaseColourPreview_MouseDoubleClick);
        ...
        #region Constructor
        public CircularPictureBoxControlOld()
        {
            InitializeComponent();
        ...
        private void CbxBaseColourPreview_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ShowColourProperties(cbxBaseColourPreview, "Base Colour");
        }

        private void ShowColourProperties(CircularPictureBox control, string colourDescription)
        {
            KryptonColourPalettePropertiesWindow palettePropertiesWindow = null;

            palettePropertiesWindow = new KryptonColourPalettePropertiesWindow();

            palettePropertiesWindow.UpdateUI(control, colourDescription);
        }
        #endregion
    }
}