...
using ExtendedControls.ExtendedToolkit.UI.CalendarLibrary;
...
namespace ExtendedControls.ExtendedToolkit.CalendarLibrary
{
    ...
    [System.Drawing.ToolboxBitmapAttribute(typeof(System.Windows.Forms.MonthCalendar)), ToolboxItem(false)]
    public partial class Calendar : DataGridView
    {
        ...
        public void SetData(DataTable dt, string StartTimeFieldName, string EndTimeFieldName, string DescriptionFieldName, string TenatativeFieldName, string KeyFieldName, string ColorFieldName)
        {
            ...
            for (i = 0; i < dv.Count; i++)
            {
                ...
                if (TenatativeFieldName != null) Boolean.TryParse(dv[i][TenatativeFieldName].ToString(), out Tentative);
