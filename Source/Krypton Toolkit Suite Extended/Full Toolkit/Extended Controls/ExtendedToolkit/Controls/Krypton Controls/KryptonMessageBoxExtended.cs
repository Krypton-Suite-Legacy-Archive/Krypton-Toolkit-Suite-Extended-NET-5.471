...
namespace ExtendedControls.ExtendedToolkit.Controls
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    [ToolboxBitmap(typeof(KryptonMessageBoxExtended), "ToolboxBitmaps.KryptonMessageBox.bmp")]
    ...
    public class KryptonMessageBoxExtended : KryptonForm
    {
        ...
        private MessageButton _button1, _button2, _button3;
        private KryptonPanel _panelMessage, _panelMessageText, _panelMessageIcon, _panelButtons;
        ...
        private KryptonMessageBoxExtended(IWin32Window showOwner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton, MessageBoxOptions options, HelpInformation helpInformation, bool? showCtrlCopy, Font messageboxTypeface)
        {
            #region Store Values
            _text = text;
        ...
        private KryptonMessageBoxExtended(IWin32Window showOwner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton, MessageBoxOptions options, HelpInformation helpInformation, bool? showCtrlCopy, Font messageboxTypeface, bool topMost = true)
        {
            #region Store Values
            _text = text;
        ...
        /// <param name="topMost">if set to <c>true</c> [top most].</param>
        private KryptonMessageBoxExtended(IWin32Window showOwner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton, MessageBoxOptions options, HelpInformation helpInformation, bool? showCtrlCopy, Font messageboxTypeface, bool showDoNotShowAgainOption, string doNotShowAgainOptionText, bool useTimeOutOption, int timeOut, int timeOutDelay, DialogResult defaultTimeOutResponse, string button1Text, string button2Text, string button3Text, bool topMost = true)
        {
            #region Store Values
            _text = text;
