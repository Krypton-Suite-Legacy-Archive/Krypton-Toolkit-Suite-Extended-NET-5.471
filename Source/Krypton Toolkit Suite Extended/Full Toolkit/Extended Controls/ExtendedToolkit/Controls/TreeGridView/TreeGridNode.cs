...
namespace ExtendedControls.ExtendedToolkit.Controls.TreeGridView
{
    ...
    public class TreeGridNode : DataGridViewRow//, IComponent
    {
        ...
        public TreeGridNode()
        {
            ...
            _level = -1;
            IsExpanded = false;
            _uniqueValue = this.rndSeed.Next();// +DateTime.Now.Second + DateTime.Now.Millisecond;
            _isSited = false;
        ...
        public override object Clone()
        {
            ...
            r.UniqueValue = this.rndSeed.Next();// +DateTime.Now.Second + DateTime.Now.Millisecond; 
