...
{
    public class FolderBrowserDialogExtended : CommonDialog
    {
        ...
        // ctor
        public FolderBrowserDialogExtended()
        {
            this.Reset();
        }

        // Factory Methods
        public static FolderBrowserDialogExtended PrinterBrowser()
        {
            FolderBrowserDialogExtended x = new FolderBrowserDialogExtended();
            // avoid MBRO comppiler warning when passing _rootFolderLocation as a ref:
            x.BecomePrinterBrowser();
            return x;
        }

        public static FolderBrowserDialogExtended ComputerBrowser()
        {
            FolderBrowserDialogExtended x = new FolderBrowserDialogExtended();
            // avoid MBRO comppiler warning when passing _rootFolderLocation as a ref:
