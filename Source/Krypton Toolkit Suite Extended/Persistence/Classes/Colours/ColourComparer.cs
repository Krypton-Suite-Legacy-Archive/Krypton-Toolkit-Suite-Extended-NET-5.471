...
{
    /// <summary>
    /// Provides access to colour comparison operations.
    /// </summary>
    public static class ColourComparer
    {
        ...
        private static int GetBrightness(Color colour)
        {
            //http://stackoverflow.com/a/13558570/148962

            // GRAY VALUE ("brightness")

            return GetGamma(RedLuminance * GetInverseGamma(colour.R) + GreenLuminance * GetInverseGamma(colour.G) + BlueLuminance * GetInverseGamma(colour.B));
        }
